function superbowlWin(arrayOfObjects){
    const wins = (element0) => {
        for (let element1 in element0) {
            if (element1 === "result" && element0[element1] === "W") {
                return element0;
            }
        }
    }
    console.log(arrayOfObjects.find(wins))
    if (arrayOfObjects.find(wins)) {
        return (Object.values(arrayOfObjects.find(wins)))[0];
